...
// 1---19999; reserved for system call error code (windows)
	...
	const int E_FEC_RQ_INVALID_ENCPACK = -23001;
	const int E_FEC_RQ_INVALID_OBJECT_TRANSMISSION_INFO_DATA = -23002;
	const int E_FEC_RQ_FIRST_PHASE_FAILED = -23003;
	const int E_FEC_RQ_SECOND_PHASE_FAILED = -23004;
	const int E_FEC_RQ_WAIT_MORE_SYMBOLS = -23005;
	const int E_FEC_RQ_BLOCK_SOURCE_SYMBOLS_EXCEED_LIMIT = -23006;
	...
	const int E_PCAP_CREATE_FIALED					= -27001;
	const int E_PCAP_SET_SNAPLEN_FAILED		= -27002;
	const int E_PCAP_SET_PROMISC_FAILED		= -27003;
	const int E_PCAP_SET_TIMEOUT_FAILED		= -27004;
	const int E_PCAP_SET_IMMEDIATE_MODE_FAILED		= -27005;
	const int E_PCAP_ACTIVATE_FAILED							= -27006;
	const int E_PCAP_UNSUPPORTED_DATALINK	= -27007;
	const int E_PCAP_COMPILE_FILTER_FAILED		= 27008;
	const int E_PCAP_SET_FILTER_FAILED					= 27009;
