...
//#define NETP_ENABLE_TASK_TRACK
	...
	#define NETP_TRACE_TASK NETP_VERBOSE
#else
...
//#define NETP_ENABLE_TRACE_SOCKET_OPEN_CLOSE
#ifdef NETP_ENABLE_TRACE_SOCKET_OPEN_CLOSE
	#define NETP_TRACE_SOCKET_OC NETP_INFO
#else
	#define NETP_TRACE_SOCKET_OC(...)
#endif
...
//#define NETP_ENABLE_TRACE_CHANNEL_CREATION
#ifdef NETP_ENABLE_TRACE_CHANNEL_CREATION
#define NETP_TRACE_CHANNEL_CREATION NETP_INFO
#else
#define NETP_TRACE_CHANNEL_CREATION(...)
#endif
