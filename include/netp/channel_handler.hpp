...
namespace netp {
	...
	enum channel_handler_api {
		CH_ACTIVITY_CONNECTED			= 1 << 0,
		CH_ACTIVITY_CLOSED					= 1 << 1,
		CH_ACTIVITY_ERROR					= 1 << 2,
		CH_ACTIVITY_READ_CLOSED		= 1 << 3,
		CH_ACTIVITY_WRITE_CLOSED		= 1 << 4,

		CH_INBOUND_READ					= 1 << 5,
		CH_INBOUND_READ_FROM		= 1 << 6,

		CH_OUTBOUND_WRITE				= 1 << 7,
		CH_OUTBOUND_FLUSH				= 1 << 8,
		CH_OUTBOUND_CLOSE				= 1 << 9,
		CH_OUTBOUND_CLOSE_READ	= 1 << 10,
		CH_OUTBOUND_CLOSE_WRITE	= 1 << 11,

		CH_OUTBOUND_WRITE_TO		= 1 << 12,
